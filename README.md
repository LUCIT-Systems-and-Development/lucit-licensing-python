...
The `lucit-licensing-python` package is available with [Conda](https://docs.conda.io/en/latest/) through our 
[custom Anaconda channel](https://anaconda.org/lucit) named `lucit`. 
